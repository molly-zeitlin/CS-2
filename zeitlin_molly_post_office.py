...
def main():                                                                                             #create function
    ...
    if mail_type == "UNMAILABLE":                                                                       #if mail_type is "UNMAILABLE"
        print(mail_type)                                                                                #display mail_type
        quit()                                                                                          #end code                                                                                  #DELETE THIS - only here for debugging
    ...
    if origin == "INVALID RESPONSE" or destination == "INVALID RESPONSE":                               #if either origin or destintion are "INVALID RESPONSE"
        print("UNMAILABLE")                                                                             #display "UNMAILABLE"
        quit()                                                                                          #end code
