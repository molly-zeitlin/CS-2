...
def check_win(board):
    '''
    Find all "| H |"s in board and determine user has won if 4 "| H |" found
    Args:
...
def clear_screen(seconds):
    '''
    Clears the terminal to clean up user's area
    Args:
...
def main():
    ...
    secret_board1= choose_ships(secret_board1)
    secret_board2 = choose_ships(secret_board2)
